...
RUN_NAME=${RUN_NAME:-LTX2.3-I2AV-anyflow-stage1-lora-lowres-smoke}
...
echo "Reference native script: examples/ltx2/model_training/full/LTX-2.3-I2AV-splited_lyh_4gpu.sh"
