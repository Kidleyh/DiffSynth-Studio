...
RUN_NAME=${RUN_NAME:-LTX2.3-I2AV-lyh-smoke4-legacy}
...
accelerate launch --num_processes 1 examples/ltx2/model_training/train_legacy.py \
  --dataset_base_path "" \
...
accelerate launch --config_file "$ACCELERATE_CONFIG" examples/ltx2/model_training/train_legacy.py \
